...
export default function CampaignCreator() {
    ...
    const [adForm, setAdForm] = useState<AdFormData>({ 
        ...
        pageId: '', 
        message: 'Clique aqui e saiba mais sobre nossa oferta incrível!', 
        headline: 'Oferta Especial por Tempo Limitado!', 
        // Usando uma URL de imagem de teste genérica e mais confiável
        imageUrl: 'https://i.picsum.photos/id/237/1200/628.jpg', 
        // Usando a URL da nossa própria aplicação como link de destino
        link: 'https://b2y-marketing.vercel.app' 
    });
    // --- FIM DA MUDANÇA ---
